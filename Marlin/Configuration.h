...
#define Y_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.//样机是false
#define Z_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.//样机是false
